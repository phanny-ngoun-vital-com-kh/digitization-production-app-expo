...
import { TouchableOpacity, View, Text, TouchableOpacityProps, ViewStyle, StyleProp, ActivityIndicator } from "react-native"
                        ...
                        <View style={{ flexDirection: 'row', width: '88%' }} >
                            <DataTable style={{ margin: 5 }}>
                                <DataTable.Row key={data.id}>
                                    ...
                                    {/* <Text style={{ margin: 8, fontSize: 18, }}>{data.createdBy}</Text>
                                <Text style={{ margin: 8, fontSize: 18, }}>{moment(data.createdDate).format('YYYY-MM-DD hh:mm:ss')}</Text> */}
