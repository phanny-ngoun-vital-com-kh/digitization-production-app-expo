...
import { Menu, MenuOption, MenuOptions, MenuProvider, MenuTrigger } from 'react-native-popup-menu';
import ConfirmDialog from '../Dialog';
import ProvidedListView from 'app/screens/inventory-transfer-request-warehouse/provided-list';
import ProvidedView from 'app/screens/inventory-transfer/provided';
...
const ModalInventoryTransfer: React.FC<ModalProps> = ({ data, isVisible, onClose, sapDoc, isLoading }) => {
